...
if (ENABLE_PEPTIDE_ANALYSIS) {
  analysis_options <- c("LFQ"="LFQ", "TMT"="TMT", "DIA"="DIA",
                        "LFQ (peptide)"="LFQ-peptide",
                        "TMT (peptide)"="TMT-peptide", "DIA (peptide)"= "DIA-peptide",
                        "TMT (site)"= "TMT-site", "DIA (site)"= "DIA-site")
} else {
  analysis_options <- c("LFQ"="LFQ", "TMT"="TMT", "DIA"="DIA")
}
                        ...
                        tags$ul(
                          ...
                          tags$li("For TMT:",
                                  tags$ul(
                                    ...
                                    tags$li("For site:", "Upload single-site report",
                          ...
                          tags$li("For DIA:",
                                  tags$ul(
                                    tags$li("For protein:", "Upload protein group (PG) matrix (", tags$b("report.pg_matrix.tsv"), ") generated by ",
                                            tags$a(href="https://github.com/vdemichev/DiaNN", target="_blank", "DIA-NN"),
                                            " in ", tags$a(href="https://fragpipe.nesvilab.org/", target="_blank", "FragPipe")),
                                    tags$li("For peptide:", "Upload peptide-level report (", tags$b("abundance_peptide_[MS1/MS2quant]_[normalization].tsv"), ") generated by ",
                                    ...
                                    tags$li("For site:", "Upload single site report (", tags$b("[abundance/ratio]_single-site_[normalization].tsv"), ") generated by ",
                                            tags$a(href="https://fragpipe.nesvilab.org/", target="_blank", "FragPipe")),
